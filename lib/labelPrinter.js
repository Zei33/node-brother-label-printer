import util from 'util'; // Utility module for promisifying functions
import pngparse from 'pngparse'; // Module for parsing PNG files
import usb from 'usb'; // Module for interacting with USB devices
import { convert } from './imageProcessing.js'; // Custom module for image processing
import fs from 'fs';
